			...
			<div class="container">
				<nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
					<ul class="nav navbar-nav">
						...
						<li>
							<a href="admin/user-list"><i class="fa fa-user"></i>学员管理</a>
						</li>
						<li class="active">
				...
				<div class="row">
					...
					<div class="col-xs-9">
						<div class="page-header">
							<h1><i class="fa fa-bar-chart-o"></i> 分析报告 </h1><span><a href="javascript:void();" onclick="refreshCount();">重新统计</a></span>
						</div>				
