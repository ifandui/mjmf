...
<body>
			...
			<div class="row">
				<div class="col-xs-3">
					<ul class="nav default-sidenav">
						<li><a href="customer/cust-list"> <i class="fa fa-wrench"></i>
								存量客户
						</a></li>
						<li class="nav default-sidenav"><a href="miss-fullfill-list">
								<i class="fa fa-times"></i> 差错录入
						</a></li>
						<li class="active"><a> <i class="fa fa-list-ol"></i> 积分一览
						</a></li>
				...
				<div class="col-xs-9">
					...
					<div class="expand-bk-content" id="bk-conent-exampaper">
						<div id="exampaper-header">
								...
								<table style="width: 100%;">
									...
									<c:forEach items="${pointsMap['个人基础']}" var="item">
										<tr>
											...
											<td>${item.name }</td>
											<td>${item.point }</td>
											<td><a class="h_point_del" data-id="${item.id }">X</a></td>
										</tr>
							...
							<c:forEach items="${grjcList }" var="item">
	...
	<script>
		$(function() {
			$(".h_point_del").click(function() {
				var id = $(this).data("id")
				alert(id);
			});

			
			function addRow(month,desc,name,point,id) {
	            
	            var rowTem = '<tr><td>'+month'+</td><td>'+desc+'</td><td>'+name+'</td><td>'+point+'</td><td><a class="h_point_del" data-id="'+id+'">X</a></td></tr>';
